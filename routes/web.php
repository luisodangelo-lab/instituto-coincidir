...
/*
|--------------------------------------------------------------------------
| Público: inscripción + carga de comprobante (por token)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Preinscripción (si tu flujo requiere auth)
|--------------------------------------------------------------------------
*/
...
Route::middleware(['auth'])->group(function () {
  ...
  | Admin Académico
  |--------------------------------------------------------------------------
  | NOTA: adentro del prefix NO se escribe "admin/academic/..." de nuevo.
  */
  Route::prefix('admin/academic')
    ->middleware(['role:admin,staff_l1,staff_l2,administrativo,docente'])
    ->group(function () {
